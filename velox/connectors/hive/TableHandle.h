...
class HiveTableHandle : public FileTableHandle {
 public:
  ...
  HiveTableHandle(
      ...
      const std::unordered_map<std::string, velox::connector::ColumnHandlePtr>& dataColumnHandles = {});
  ...
  const std::unordered_map<std::string, velox::connector::ColumnHandlePtr> getDataColumnHandles() const {
 ...
 private:
  ...
  bool isChangelogQuery_;
  const std::unordered_map<std::string, velox::connector::ColumnHandlePtr> dataColumnHandles_;
};
